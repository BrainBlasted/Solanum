...
{
    unsafe  {
        Option::<glib::Object>::from_glib_none(
            gtk_sys::gtk_widget_get_template_child(
...
pub trait WidgetSubclass
    where Self: ObjectSubclass + wdgt::WidgetImpl {
    unsafe fn set_template_bytes(
        ...
        gtk_sys::gtk_widget_class_set_template(
            widget_class,
            template.to_glib_none().0);
    }

    unsafe fn set_template(
        klass: &mut subclass::simple::ClassStruct<Self>,
        template: &[u8]) {
